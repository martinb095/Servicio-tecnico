...
const detalletareasRoutes_1 = __importDefault(require("./routes/detalletareasRoutes"));
const detallerepuestosRoutes_1 = __importDefault(require("./routes/detallerepuestosRoutes"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use('/detalletareas/', detalletareasRoutes_1.default);
        this.app.use('/detallerepuestos/', detallerepuestosRoutes_1.default);
