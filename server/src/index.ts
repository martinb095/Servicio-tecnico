...
import detalleTareasRoutes from './routes/detalletareasRoutes';
import detallerepuestosRoutes from './routes/detallerepuestosRoutes';
...
class Server {
    ...
    routes(): void {
        ...
        this.app.use('/detalletareas/', detalleTareasRoutes);
        this.app.use('/detallerepuestos/', detallerepuestosRoutes);
